...
export async function GET(req: Request) {
  ...
  const { data, error } = await supabase
    .rpc("get_ops_summary", {
      ...
      p_ciudad: param(searchParams, "ciudad"),
      p_restaurant: param(searchParams, "restaurant"),
      p_zona: param(searchParams, "zona"),
      p_estatus: param(searchParams, "estatus"),
      p_repartido_por: param(searchParams, "repartido_por"),
